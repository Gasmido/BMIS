    ...
    <div class="modal-inside">
        <div class="models">
            <div class="inputpop">            
                ...
                <input id="bt" class="inpu" type="text" name="name" value="<?= $blotter_type ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" readonly placeholder="Enter Blotter Type" required><br>
                <label>Complainant: (NAGREKLAMO)</label><br>
                <input id="cp" class="inpu" type="text" name="complainant" value="<?= $complainant ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" readonly placeholder="Enter Complainant" required><br>
                
               
            </div>
            <div class="inputpop2">
                <label>Complained: (WHO)</label><br>
                <input id="cpd" class="inpu" type="text" name="complained" value="<?= $complained ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" readonly placeholder="Enter Complained" required><br>
                <label>Location of Incident: (WHERE)</label><br>
                <input id="loi" class="inpu" type="text" name="Location" value="<?= $locationOfIncident ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Location" readonly required><br>
            ...
            <div class="inputpop3">
                ...
                <input id="pin" onkeyup="saveValue(this);" class="inpu" type="text" name="pin" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Name" value="<?= $pin ?>" readonly required></input><br>
                <label>Status:</label>
        ...
        <label for="blotterin" style="padding-left:20px">Blotter Information: (WHY)</label><br>
                ...
                <textarea class="inpuer" id="blotterin" name="BI" rows="35" cols="5" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);" readonly required><?php echo $blotter_info; ?></textarea>
      </div>
    </div>
</form>
  </div>
