    ...
    <div class="modal-inside">
        <div class="models">
            ...
            <div class="inputpop2">
                ...
                <input id="bt" class="inpu" type="text" name="name" value="<?= $name ?>" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" readonly placeholder="Enter Fullname" required>
