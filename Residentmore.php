            ...
            $sql2 = "SELECT * FROM resident WHERE id=".$idd;
                 ...
                 if ($result2-> num_rows > 0) {
                        ...
                        $timezone = new DateTimeZone('Asia/Manila');
                         ...
                         $birthDate = new DateTime($birth); // Create DateTime object from birthdate
        ...
        <div class="models">
            <div class="inputpop">            
               <label>First Name:</label><br>
                <input id="9" class="inpu" type="text" name="fname" value="<?= $fname ?>" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="First Name" readonly><br>
                <label>Middle Initial/Name:</label><br>
                <input id="10" class="inpu" type="text" name="mname" value="<?= $mname ?>" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="Middle Name/Initial" readonly><br>
                <label>Last Name:</label><br>
                <input id="11" class="inpu" type="text" name="lname" value="<?= $lname ?>" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="Last Name" readonly><br>
                <label>Extension Name:</label><br>
                <input id="12" class="inpu" type="text" name="ename" value="<?= $ename ?>" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="Extension Name" readonly><br>
           <!--     <label>Phone Number:</label><br>
            ...
            <div class="inputpop2">
                ...
                <label>Age:</label><br>
                                <input id="age" class="inpu" type="text" name="age" value="<?= $age ?>" readonly placeholder="Age"><br>
               <input type="text" name="ids" value="<?= $ids ?>" hidden>
            </div>
            <div class="inputpop3">
                <label>Street:</label><br>
                <input id="5" class="inpu" type="text" name="brgy" value="<?= $brgy ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Barangay" readonly><br>
                ...
                <label>City:</label><br>
                <input id="7" class="inpu" type="text" name="city" value="<?= $city ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="City" readonly><br>
                <label>Province:</label><br>
                <input id="8" class="inpu" type="text" name="province" value="<?= $province ?>" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Province" readonly><br>
