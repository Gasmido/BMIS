...
<div class="admin-homes"> 
    <div class="admin-events">
         <form class="announceform" method="post" action="ANmore2" enctype="multipart/form-data">
            ...
            <input class="inpus" type="text" name="title" id="title" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> '')" value="<?= $newsTitle ?>"><br><br>
            <label for="desc">News Description:</label><br>
            <textarea class="inpuers" name="desc" id="desc" rows="35" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> '')" cols="100"><?php echo $newsDesc; ?></textarea>
