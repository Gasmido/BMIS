    ...
    <div class="modal-inside">
        <div class="models">
            <div class="inputpop">            
                ...
                <input id="9" class="inpu" type="text" name="houseno" placeholder="Household no." pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" value="<?= $Houseno ?>" onkeyup="saveValue(this);" required readonly> <br>
                <label>Street:</label><br>
                <input id="10" class="inpu" type="text" name="st" placeholder="Street" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" value="<?= $Street ?>" onkeyup="saveValue(this);" readonly required><br>
