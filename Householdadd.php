    ...
    <div class="modal-inside">
        <div class="models">
            <div class="inputpop">  
                ...
                <br>
                <input id="9" class="inpu" type="text" name="houseno" placeholder="Household no." pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" onkeyup="saveValue(this);" required><br>
                <label>Street:</label><br>
                <input id="10" class="inpu" type="text" name="st" placeholder="Street" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" onkeyup="saveValue(this);" required><br>
            ...
            <div class="inputpop2">
              ...
              <label for="">Inhabitants:</label>
                ...
                <?php
                    if (isset($_SESSION['stas'])) {
                                    echo "<p style='text-align:center;font-size:17px;font-weight:bold;color:red;display: inline-flex;' id='ha'>";
                                    echo $_SESSION['stas']; echo "</p>";
                                    unset($_SESSION['stas']);
                    }
                ?>
