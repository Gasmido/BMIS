                        ...
                        while ($row = $result-> fetch_assoc()) {
                            echo '
                                ...
                                <div class="property-item rounded overflow-hidden">
                                    ...
                                    <form action="newsmore" method="post" style="height:100%">
                                    <input type="text" name="cor" value="'. $row['id'] .'" hidden></input>
                                    <div class="position-relative overflow-hidden">
                                        <button type="submit" name="submit" style="border:none;"><img class="img-fluid" src="image/'. $row['newsPic'] .'" alt="" style="min-height:300px;max-height:330px;">
									...
									<div class="p-4 pb-0">
                                        <button type="submit" name="submit" style="border:none;background:none">
                                        	<p class="d-block h5 mb-2">'. $row['newsTitle'] .'</p>
                                        </button>
                                    </div>
                                   	</form>  
