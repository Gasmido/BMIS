...
if (isset($_SESSION['ID']) && $status == "Approved"){
if ($docutype == "") {
		...
		<div class="docu-form">
            ...
            unset($_SESSION['statusss']);
				...
				if ($docutype == "Certificate of Residency") {
					...
					<form action="docreqadd" method="post"">
					<label>Document Requesting:</label>
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly></input>
				<label>Full Name: <span style="color:red;font-weight:400">(1)</span></label>
				<input disabled id="q1" type="text" name="fName" class="inputt" minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Purok: <span style="color:red;font-weight:400">(2)</span></label>
				<label for="item"></label>
	    		<select disabled id="item" name="purok" class="hehe" class="inputt" required>
			      <option>1</option>
			      <option>2</option>
			      <option>3</option>
			      <option>4</option>
    		...
    		<br />
    		<label>Date of Residence: <span style="color:red;font-weight:400">(3)</span></label>
				<input disabled type="date" name="dateofres" class="inputt" max="'; echo date("Y-m-d"); echo '" min="1934-12-31" step="1" required></input>
				<label>Purpose:</label><br />		
				<label for="items"></label>
			    <select disabled id="items" name="purpose" class="hehe" class="inputt" required>
			      <option>For Work</option>
			      <option>For School</option>
			    </select>
   			 <br />
        <input disabled id="boxc" type="checkbox" class="check" name="otherrs"></input>
    <label>Other:</label> <br>

    <input disabled id="otex" type="text" class="ohter" name="oth" maxlength="150" pattern="[A-Za-z ]{1,150}" title="Only letters and spaces. Maximum of 150" placeholder="max. of 150 letters only" required disabled></input>
    <section style="text-align:center">
				';
				if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									echo '<button class="btnservice" type="submit" name="submit">Submit</button>
									
									';
								} elseif ($status == "Denied") {
									echo '<p class="boxreq" style="width:100%">Sorry but your account have been denied to access this service.</p>';
								} elseif ($status == "Processing") {
									echo '<p class="boxreq" style="width:100%">Please wait for admin to approve your account to access this service.</p>';
								}
							}
							else {
								echo '<p class="boxreq" style="width:100%">Please <a href="login">LOGIN</a> to request this document</p>';
							}
						echo '
			</section>
			</form>
		...
		elseif ($docutype == "Certificate of Indigency") {
			...
			<form action="docreqadd" method="post" id="halo">
				...
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly></input>
				<label>Full Name: <span style="color:red;font-weight:400">(1)</span></label>
				<input disabled id="w1" type="text" name="fName" class="inputt"  minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Reason for Indigency Request: <span style="color:red;font-weight:400">(2)</span></label>
				<label for="item2"></label>
	    		<select disabled id="item2" name="reason" class="hehe" class="inputt" required>
			      <option>Presently confine at the hospital</option>
			      <option>Need burial assistance</option>
			    </select>
    		<br />
        <input disabled id="boxc2" type="checkbox" class="check" name="otherrs2"></input>
    <label>Other: <span style="color:red;font-weight:400">(3)</span></label> <br>

    <input disabled id="otex2" type="text" class="ohter" name="oth2" maxlength="150" pattern="[A-Za-z ]{1,150}" title="Only letters and spaces. Maximum of 150" placeholder="max. of 150 letters only" required disabled></input>
    <section>
';
				if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
		...
		elseif ($docutype == "Barangay Clearance") {
			$_SESSION['type'] = $docutype;
				...
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly></input>
				<label>Full Name: <span style="color:red;font-weight:400">(1)</span></label>
				<input disabled id="e1" type="text" name="fName" class="inputt"  minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label for="item">Purok: <span style="color:red;font-weight:400">(2)</span></label>
	    		<select disabled id="item" name="purok" class="hehe" class="inputt" required>
			      <option value="1">1</option>
			      <option value="2">2</option>
    		...
    		<br />
    		<label>Date of Birth: <span style="color:red;font-weight:400">(3)</span></label>
				<input disabled type="date" name="dateofbirth" class="inputt" max="'; echo date("Y-m-d"); echo '" min="1934-12-31" step="1" required></input>
				<label>Place of Birth: <span style="color:red;font-weight:400">(4)</span></label>
				<input disabled id="e2" type="text" name="placeofbirth" class="inputt" minlength="4" maxlength="50" pattern="[A-Za-z0-9 ]{4,50}" placeholder="Address" required></input>
				<label>Height: (cm) <span style="color:red;font-weight:400">(5)</span></label>
				<input disabled id="e3" type="text" name="height" class="inputt" minlength="1" maxlength="3" pattern="[0-9 ]{1,3}" placeholder="Please use the Centimeters" step="0.01" title="Numbers only" required></input>
				<label>Weight: (Kg) <span style="color:red;font-weight:400">(6)</span></label>
				<input disabled id="e4" type="text" name="weight" class="inputt" minlength="1" maxlength="3" pattern="[0-9 ]{1,3}" placeholder="Please use the Kilograms" title="Numbers only"  step="0.01" required></input>
				<label for="csts">Civil Status: <span style="color:red;font-weight:400">(7)</span></label>
	    		<select disabled id="csts" name="civilstat" class="hehe" class="inputt" required>
			      <option value="Single">Single</option>
			      <option value="Married">Married</option>
			      <option value="Widowed">Widowed</option>
			      <option value="Divorced">Divorced</option>
				...
				<label for="items">Purpose:</label>
    <input disabled id="items" type="text" class="ohter" name="purpose" maxlength="150" pattern="[A-Za-z/ ]{1,150}" title="Only letters and spaces. Maximum of 150" placeholder="max. of 150 letters only" value="Personal/Reference Purposes" required></input>
   			 <br />
    <section>
';
				if (isset($_SESSION['ID'])) {
		...
		elseif ($docutype == "Kasunduan") {
			$_SESSION['type'] = $docutype;
				...
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly></input>
				<label>Borrower: <span style="color:red;font-weight:400">(1)</span></label>
				<input disabled id="r1" type="text" name="BName" class="inputt"  minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Lender: <span style="color:red;font-weight:400">(4)</span></label>
				<input disabled id="r2" type="text" name="LName" class="inputt" minlength="4" maxlength="50"  pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Borrower'; echo "'"; echo 's Barangay:  <span style="color:red;font-weight:400">(2)</span></label>
				<input disabled id="r3" type="text" name="address" class="inputt" minlength="4" maxlength="50" pattern="[A-Za-z0-9 ]{4,50}" placeholder="e.g. Maturanoc" required></input>
				<label>Money Borrowed: <span style="color:red;font-weight:400">(3)</span></label>
				<input disabled id="r4" type="text" name="Money" class="inputt" minlength="1" maxlength="9" pattern="[0-9 ]{1,9}" placeholder="Php" title="Numbers only" required></input>
				<label>Borrower'; echo"'"; echo 's Agricultural Land Size: (Hectares) <span style="color:red;font-weight:400">(5)</span></label>
				<input disabled id="r5" type="text" name="BAL" class="inputt" minlength="4" maxlength="50" pattern="[0-9. ]{1,50}" placeholder="Land you will lent to the Lender" step="0.001" required></input>
				<label>Borrower'; echo"'"; echo 's Agricultural Land Barangay Location: <span style="color:red;font-weight:400">(6)</span></label>
				<input disabled id="r6" type="text" name="BALL" class="inputt" minlength="4" maxlength="50" placeholder="e.g. Ayos Lomboy" required></input>    		
    <section>
';
				if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
		...
		elseif ($docutype == "BARC") {
			$_SESSION['type'] = $docutype;
					...
					<form action="docreqadd" method="post"">
					<label>Document Requesting:</label>
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .' Certification	" required readonly></input>
				<label>Full Name: <span style="color:red;font-weight:400">(1)</span></label>
				<input disabled id="t1" type="text" name="fName" class="inputt"  minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Residing Barangay: <span style="color:red;font-weight:400">(2)</span></label>
				<input disabled id="t2" type="text" name="rbrgy" class="inputt" minlength="4" maxlength="50" pattern="[A-Za-z0-9 ]{4,50}" placeholder="e.g. Cavite" required></input>
				<label>Agricultural Land area: (sq.m. & hectares) <span style="color:red;font-weight:400">(3 & 4)</span></label><br>
				<input disabled id="t3" type="text" name="sqm" class="inputt" minlength="1" maxlength="10" pattern="[0-9 ]{1,10}" placeholder="sq. m." step="0.01" title="Numbers only" style="width:49%;" required></input>
				<input disabled id="t4" type="text" name="hectare" class="inputt" minlength="1" maxlength="10" pattern="[0-9 ]{1,10}" placeholder="Hectares" step="0.01" title="Numbers only" style="width:49%;" required></input><br>
				<label>Registered Owner of Agricultural Land: <span style="color:red;font-weight:400">(5)</span></label>
				<input disabled id="t5" type="text" name="owner" class="inputt" minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full Name" required></input>
   			 <br />
    <section>
';
				if (isset($_SESSION['ID'])) {
		...
		elseif ($docutype == "Blotter") {
			$_SESSION['type'] = $docutype;
					...
					<h1>BLOTTER REQUEST</h1>
					<form action="docreqadd" method="post"">
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly hidden></input>
				<label>Nagreklamo:</label>
				<input disabled id="y1" type="text" name="fName" class="inputt"  minlength="4" maxlength="50" pattern="[A-Za-z., ]{4,50}" placeholder="Full name" required></input>
				<label>Inerereklamo:</label>
				<input disabled id="y2" type="text" name="complained" class="inputt" pattern="[A-Za-z ]{2,32}" title="Please remove any special characters! max-length(32 letters)" maxlength="100" placeholder="Full name" required></input>
				<label>Location of Incident: (Purok)</label>
				<label for="item"></label>
	    		<select disabled id="item" name="purok" class="hehe" class="inputt" required>
			      <option>1</option>
    		...
    		<br />
				...
				<label>Phone Number:</label>
				<input disabled id="y3" type="text" minlength="11" name="phonenum" class="inputt" pattern="09.\d*" title="Please Enter numbers only! e.g. 0912345689" maxlength="11" placeholder="e.g. 09123456789" required></input>
				<label>Incident Type:</label>
				<input disabled id="y4" type="text" name="incidenttype" class="inputt" pattern="[A-Za-z ]{2,64}" title="Please remove any special characters!" maxlength="100" placeholder="e.g. Assault" required></input>
				<label>Incident Details:</label>
				<textarea disabled id="y5" rows="4" cols="50" type="text" name="incidentdetails" class="inputt"  onkeyup="this.value = this.value.replace(/[&*<>'; ?>'<?php echo ']/g,'; ?> ''<?php echo ')" pattern="[A-Za-z ]{1,300}" title="Please remove any special characters!" maxlength="300" placeholder="Explain what happened (max. 300 letters)" required></textarea>
...
';
			...
			<form action="docreqadd" method="post" id="bye">
				...
				<input disabled type="text" name="docutype" class="inputt" value="'. $docutype .'" required readonly></input>
				<label>Full Name:</label>
				<input disabled type="text" name="fName" class="inputt"  required></input>
