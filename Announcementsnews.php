...
<div class="admin-homes"> 
    <div class="admin-events">
        <form class="announceform" method="post" action="Announcementsnewsadd" enctype="multipart/form-data">
            ...
            <input class="inpus" type="text" name="title" id="title" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);"><br><br>
            <label for="desc">News' Description:</label><br>
            <textarea class="inpuers" name="desc" id="desc" rows="35" cols="100" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);"></textarea>
