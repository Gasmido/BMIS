    ...
    <div class="modal-inside">
        <div class="models">
            ...
            <div class="inputpop3">
                ...
                <input id="pin" onkeyup="saveValue(this);" class="inpu" type="text" name="pin" placeholder="Enter Name" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" value="<?= $pin ?>" readonly required></input><br>
                <label>Status:</label>
