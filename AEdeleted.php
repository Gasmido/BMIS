...
<div class="admin-homes"> 
    <div class="admin-events">
        <form class="announceform" method="post" action="AEmore2" enctype="multipart/form-data">
            ...
            <input class="inpus" type="text" name="title" id="title" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);" value="<?= $eventTitle ?>"><br><br>
            <label for="desc">Event's Description:</label><br>
            <textarea class="inpuers" name="desc" id="desc" rows="35" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);" cols="100"><?php echo $eventDesc; ?></textarea>
