    ...
    <div class="modal-inside">
        <div class="models">
            <div class="inputpop">            
                ...
                <input id="bt" onkeyup="saveValue(this);" class="inpu" type="text" name="name" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Blotter Type" required></input><br>
                <label>Complainant: (NAGREKLAMO)</label><br>
                <input id="cm" onkeyup="saveValue(this);" class="inpu" type="text" name="complainant" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Complainant" required></input><br>
                
               
            </div>
            <div class="inputpop2">
                <label>Complained: (WHO)</label><br>
                <input id="cmd" onkeyup="saveValue(this);" class="inpu" type="text" name="complained" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Complained" required></input><br>
                <label>Location of Incident: (WHERE)</label><br>
                <input id="lois" onkeyup="saveValue(this);" class="inpu" type="text" name="Location" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" placeholder="Enter Location" required></input><br>
            ...
            <div class="inputpop3">
                ...
                <input id="pin" onkeyup="saveValue(this);" class="inpu" type="text" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" name="pin" placeholder="Enter Name" required></input><br>
                <label>Status:</label>
...
<label for="blotterin" style="padding-left:20px">Blotter Information: (WHY)</label><br>
                ...
                <textarea class="inpuer" id="blotterin" onkeyup="this.value = this.value.replace(/[&*<><?php echo ']/g,'; ?> ''); saveValue(this);" name="BI" rows="35" cols="5" required></textarea>
      </div>
