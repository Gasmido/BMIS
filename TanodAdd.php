    ...
    <div class="modal-inside">
        <div class="models">
            ...
            <div class="inputpop2">
                ...
                <input id="bt" class="inpu" type="text" name="name" onkeyup="saveValue(this);" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="Enter Fullname" required><br>
