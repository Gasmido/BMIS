    ...
    <div class="modal-inside">
        <div class="models">
            <div class="inputpop">  
                ...
                <input id="9" class="inpu" type="text" name="fname" placeholder="First Name" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" onkeyup="saveValue(this);" required><br>
                <label>Middle Name:</label><br>
                <input id="10" class="inpu" type="text" name="mname" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" placeholder="Middle Name/Initial" onkeyup="saveValue(this);"><br>
                <label>Last Name:</label><br>
                <input id="11" class="inpu" type="text" name="lname" placeholder="Last Name" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" onkeyup="saveValue(this);" required><br>
                <label>Extension Name:</label><br>
                <input id="12" class="inpu" type="text" name="ename" placeholder="Extension Name" pattern="[A-Za-z., ]{1,80}" title="Only letters, periods and commas" onkeyup="saveValue(this);"><br>
        ...
        ?>    
            ...
            <div class="inputpop3">
                ...
                <input class="inpu" type="text" name="brgy" placeholder="Street" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" onkeyup="saveValue(this);" required><br>
                ...
                <label>City:</label><br>
                <input class="inpu" type="text" name="city" placeholder="City" value="Guimba" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" onkeyup="saveValue(this);" required><br>
                <label>Province:</label><br>
                <input  class="inpu" type="text" name="province" placeholder="Province" value="Nueva Ecija" pattern="[A-Za-z.,0-9 ]{1,80}" title="Only letters, numbers, periods and commas" onkeyup="saveValue(this);" required><br>
