...
<div class="homepage docud" style="margin-top:0">
	<div class="adddell" style="background-color: transparent;">
        <?php
	...
	<div class="docu-home">
		<div class="docu-form" style="margin-top:0px;height:860px">
               ...
               <input type="text" name="idd" value="<?= $id ?>" hidden></input>
				...
				<section>
				<button style="margin-top: 50px;" id="editsub" type="submit" name="submits" class="docusub" hidden>Submit</button>
